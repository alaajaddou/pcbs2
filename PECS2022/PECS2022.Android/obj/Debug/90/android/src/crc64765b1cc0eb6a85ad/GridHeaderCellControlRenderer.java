...
public class GridHeaderCellControlRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.SfDataGrid.XForms.Droid.GridHeaderCellControlRenderer, Syncfusion.SfDataGrid.XForms.Android", GridHeaderCellControlRenderer.class, __md_methods);
	}
	...
	public GridHeaderCellControlRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == GridHeaderCellControlRenderer.class)
			mono.android.TypeManager.Activate ("Syncfusion.SfDataGrid.XForms.Droid.GridHeaderCellControlRenderer, Syncfusion.SfDataGrid.XForms.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
