    ...
    public class MpEntry : Entry, IControlValidation
    {
        ...
        public void CheckValidation()
        {
            ...
            if (this.BindingContext != null && this.BindingContext is INotifyDataErrorInfo)
            {
                ...
                // Get value
                //var _propertiesObj = _propertiesFieldInfo
                //                 .GetValue(this);
                ...
                //   var _properties = _propertiesObj as IDictionary; //Dictionary<BindableProperty, BindablePropertyContext>;
                //   // Get first object
                //var enumer=_properties.GetEnumerator();

                //  var fields = _properties.GetEnumerator()
                //       .GetType()
                //       .GetRuntimeFields();
                ...
                BindingPath = binding.Path;// = GetValue(Entry.BindingContextProperty) as Binding;
