...
namespace PECS2022
{
   public class BaseControlValidation<T>
                where T : BindableObject, IControlValidation
    {
        ...
        private BindableProperty _BindableProperty;
        ...
        public BaseControlValidation(T Control, string ToValidatePropertyName, BindableProperty BindableProperty, Action<bool, string> SetPrivateProperties)
        {
            this._control = Control;
            this._toValidatePropertyName = ToValidatePropertyName;
            this._SetPrivatePropertiesAction = SetPrivateProperties;
            this._BindableProperty = BindableProperty;
        }
        #endregion
        /// <summary>
        ...
        public void CheckValidation()
        {
            ...
            if (this._control.BindingContext != null && this._control.BindingContext is INotifyDataErrorInfo)
            {
                ...
                var binding = _control.GetBinding(_BindableProperty);
